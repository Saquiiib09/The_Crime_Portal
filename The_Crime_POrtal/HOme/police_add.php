...
if(isset($_POST['s'])){
    ...
    $reg="insert into police values('$p_name','$p_id','$p_email','$spec','$location','$p_pass')";
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="police_add.php">Add Police Officer</a></li>
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
		 <div class="bg-agile">
			<br><br>
			<div class="login-form"><p><h2>Add Police Officer</h2></p><br>	
				<form action="police_add.php" method="post" style="color: gray">Police Name
          ...
          <!-- myaddition of police email -->
          Police Email <input type="text"  name="police_email" placeholder="Police email" required="" id="pemail" onfocusout="f1()"/>




          <!-- my additon of police email -->
...
<!-- disabled value="<?php echo "$location"; ?> -->